...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path= Path('/home/code/hyperradar/dataset/view_of_delft_PUBLIC/radar_5frames'),
            save_path= Path('/home/code/hyperradar/dataset/view_of_delft_PUBLIC/radar_5frames')
        )
