...
class KittiDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.sim_info_path_list = [
            Path('/root/share/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.005/'),
            Path('/root/share/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.010/'),
            Path('/root/share/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.020/'),
            Path('/root/share/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.030/'),
        ]
        self.sim_info_path = Path('/root/share/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.060/') 
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path= Path('/root/share/view_of_delft_PUBLIC/lidar/'),
            save_path= Path('/root/share/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.100/')
        )
